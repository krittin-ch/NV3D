...
from ..backbones_3d import pfe, vfe, vector_fe
...
class Detector3DTemplate(nn.Module):
    def __init__(self, model_cfg, num_class, dataset):
        ...
        self.module_topology = [
            'vfe', 'vector_fe', 'backbone_3d', 'map_to_bev_module', 'pfe',
            'backbone_2d', 'dense_head',  'point_head', 'roi_head'
        ]
    ...
    def build_vector_fe(self, model_info_dict):
        if self.model_cfg.get('VECTOR_FE', None) is None:
            return None, model_info_dict

        vector_fe_module = vector_fe.__all__[self.model_cfg.VECTOR_FE.NAME](
            model_cfg=self.model_cfg.VECTOR_FE,
            num_point_features=model_info_dict['num_rawpoint_features'],
        )
        
        model_info_dict['num_point_features'] = vector_fe_module.get_output_feature_dim()
        model_info_dict['module_list'].append(vector_fe_module)
        return vector_fe_module, model_info_dict    
